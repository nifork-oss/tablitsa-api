          ...
          for (const incUser of incoming.users) {
            ...
            if (incUser.pass) {
              ...
              newUsersList.push({
                ...
                notesAccessExpiresAt: incUser.notesAccessExpiresAt ?? (existing ? existing.notesAccessExpiresAt : null),
                pass,
              });
            } else if (existing) {
              newUsersList.push({
                ...
                notesAccessExpiresAt: incUser.notesAccessExpiresAt ?? existing.notesAccessExpiresAt,
              });
            }
          }
