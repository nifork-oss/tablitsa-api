  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (path === "/appdata" && request.method === "GET") {
        ...
        return json({
          data: { reports: record.reports, users: stripPasswords(record.users), ppNorms: record.ppNorms || {}, mergeLog: record.mergeLog || [], reportStatus: record.reportStatus || {}, personMeta: record.personMeta || {}, groupRoster: record.groupRoster || [], groupRosterDraft: isSuperadmin ? (record.groupRosterDraft || []) : [], rosterNotes: hasNotesAccess ? (record.rosterNotes || {}) : {} },
          role: auth.role,
          email: auth.email,
        });
      }
      ...
      if (path === "/appdata" && request.method === "PUT") {
        ...
        return json({ data: { reports: record.reports, users: stripPasswords(record.users), ppNorms: record.ppNorms || {}, mergeLog: record.mergeLog || [], reportStatus: record.reportStatus || {}, personMeta: record.personMeta || {}, groupRoster: record.groupRoster || [], groupRosterDraft: isSuperadmin ? (record.groupRosterDraft || []) : [], rosterNotes: hasNotesAccessFinal ? (record.rosterNotes || {}) : {} } });
      }
